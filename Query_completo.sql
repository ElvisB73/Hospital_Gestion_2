...
INSERT INTO Doctor (titulo, apellido, nombre, especialidad) VALUES
('Dr.',  'Báez',     'Carlos',  'Clínica General'),
('Dra.', 'García',   'María',   'Pediatría'),
('Dr.',  'López',    'Roberto', 'Cardiología'),
('Dra.', 'Martínez', 'Ana',     'Traumatología'),
('Dr.',  'Ramon',   'Luis',    'Guardia')
...
ORDER BY PR.nivel;
GO
SELECT * FROM Turno WHERE estado = 'Cancelado'